...
public interface ConversationLifecycleListener {
	 ...
	 * yet started. <p/> If you need to add items to the subflow scope, put them in aInput.
	 * 
	 ...
	 * because the flow session for the child flow has not yet started. <p/> If you need to add items to the subflow
	 ...
	 * flow has not yet continued. <p/> If you need to add items to the parent flow scope, put them in aOutput.
	 * 
	 * @param aContext The request context
	 ...
	 * method because the flow session for the child flow has not yet started. <p/> If you need to add items to the
