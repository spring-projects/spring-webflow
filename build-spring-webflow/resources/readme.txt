...
* org.springframework.webflow-2.2.0.M1.jar
...
* org.springframework.binding-2.2.0.M1.jar
...
* org.springframework.js-2.2.0.M1.jar
...
* org.springframework.faces-2.2.0.M1.jar
...
<dependency org="org.springframework.webflow" name="org.springframework.binding" rev="2.2.0.M1" conf="compile->runtime" />
<dependency org="org.springframework.webflow" name="org.springframework.js" rev="2.2.0.M1" conf="compile->runtime" />
<dependency org="org.springframework.webflow" name="org.springframework.webflow" rev="2.2.0.M1" conf="compile->runtime" />

If using JavaServerFaces:

<dependency org="org.springframework.webflow" name="org.springframework.faces" rev="2.2.0.M1" conf="compile->runtime" />
